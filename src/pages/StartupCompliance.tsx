          ...
          <div className="absolute -bottom-16 lg:-bottom-12 left-1/2 -translate-x-1/2 w-[90%] lg:w-[80%] bg-white rounded-3xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-stone-200 p-6 lg:p-8 z-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 divide-y md:divide-y-0 md:divide-x divide-stone-200 text-center">
              <div className="pt-4 md:pt-0">
                <div className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Timeline</div>
                <div className="text-3xl lg:text-4xl font-black text-slate-900">4 Weeks</div>
              </div>
              <div className="pt-4 md:pt-0">
                <div className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Frameworks</div>
                <div className="text-3xl lg:text-4xl font-black text-slate-900">DPDP & SOC2</div>
              </div>
              <div className="pt-4 md:pt-0">
                <div className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Pipeline Unblocked</div>
                <div className="text-3xl lg:text-4xl font-black text-emerald-500">$2M+</div>
              </div>
            </div>
          </div>
        </div>
