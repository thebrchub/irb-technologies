import { ArrowLeft, ShieldAlert, Target, ShieldCheck, Clock, Server } from 'lucide-react';
        ...
        >
          <div className="grid grid-cols-3 gap-0 md:gap-8 divide-x divide-stone-200 text-center items-center">
            <div className="px-1 md:px-2">
              <div className="text-[9px] md:text-xs 2xl:text-sm font-bold text-slate-400 uppercase tracking-widest mb-1 md:mb-2 truncate">{content.scaleLabel}</div>
              <div className="text-lg md:text-3xl lg:text-4xl 2xl:text-6xl font-black text-slate-900">{content.scaleValue}</div>
            </div>
            <div className="px-1 md:px-2">
            ...
            <div className="px-1 md:px-2">
              <div className="text-[9px] md:text-xs 2xl:text-sm font-bold text-slate-400 uppercase tracking-widest mb-1 md:mb-2 truncate">{content.uptimeLabel}</div>
              <div className="text-lg md:text-3xl lg:text-4xl 2xl:text-6xl font-black text-emerald-500">{content.uptimeValue}</div>
            </div>
          </div>
        </motion.div>
