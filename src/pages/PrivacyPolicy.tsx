        ...
        <div className="space-y-6 md:space-y-10">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {(content.sections[1] as any).cards?.map((card: any, index: number) => (
                    <div key={index} className="p-4 md:p-5 bg-white rounded-2xl border border-slate-200 hover:border-[#C45919]/25 hover:shadow-md transition-all">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-[#C45919]" />
                        <h3 className="font-bold text-[#2B3A4A] text-sm md:text-base">{card.title}</h3>
                      </div>
          ...
          <div className="relative overflow-hidden bg-[#2B3A4A] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 shadow-2xl shadow-[#2B3A4A]/20">
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-8">
              ...
              >
                <Mail size={18} /> {content.cta.buttonText}
              </a>
            </div>
          </div>
