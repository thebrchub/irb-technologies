        ...
        <div className="mb-14">
          <div className="flex flex-wrap gap-3 mb-6">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#C45919]/8 rounded-full text-[10px] font-bold text-[#C45919] uppercase tracking-wider">
              <ShieldCheck size={10} /> DPDP Compliant
            </div>
        ...
        <div className="space-y-10">
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <h2 className="text-xl font-bold text-[#2B3A4A]">Commitment to Confidentiality</h2>
                </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <h2 className="text-xl font-bold text-[#2B3A4A]">Scope of Data Processing</h2>
                </div>
                <div className="w-8 h-0.5 bg-[#C45919]/30 rounded mb-4" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-5 bg-white rounded-2xl border border-slate-200 hover:border-[#C45919]/25 hover:shadow-md transition-all">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#C45919]" />
                      <h3 className="font-bold text-[#2B3A4A] text-sm">Administrative Data</h3>
                    </div>
                  ...
                  <div className="p-5 bg-white rounded-2xl border border-slate-200 hover:border-[#C45919]/25 hover:shadow-md transition-all">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#C45919]" />
                      <h3 className="font-bold text-[#2B3A4A] text-sm">Technical Intelligence</h3>
                    </div>
                    <p className="text-xs leading-relaxed text-slate-500">
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <h2 className="text-xl font-bold text-[#2B3A4A]">Data Residency & Encryption</h2>
                </div>
                <div className="w-8 h-0.5 bg-[#C45919]/30 rounded mb-4" />
          ...
          <div className="relative overflow-hidden bg-[#2B3A4A] rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-[#2B3A4A]/20">
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              <div>
                <p className="text-[10px] font-mono text-[#C45919]/70 tracking-widest uppercase mb-3">Privacy Officer Contact</p>
                <h2 className="text-2xl font-bold text-white mb-2">Questions regarding privacy?</h2>
              ...
              <a
                ...
                className="shrink-0 flex items-center gap-3 px-8 py-4 bg-[#C45919] hover:bg-[#A34915] text-white font-black rounded-2xl transition-all shadow-lg shadow-[#C45919]/30 active:scale-95 whitespace-nowrap"
              >
