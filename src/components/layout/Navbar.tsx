...
const Navbar = ({ onOpenModal }: NavbarProps) => {
  ...
  const effectiveExpanded = isHovered || isExpanded || scrollY < 50;
  ...
  return (
    <>
      ...
      <nav 
        className={`fixed left-0 right-0 z-50 flex justify-center transition-transform duration-500 ease-in-out ${
      ...
      >
        ...
        >
          ...
          <div className={`absolute inset-0 bg-gradient-to-r from-[#C45919]/0 via-[#C45919]/5 to-[#2B3A4A]/0 opacity-0 transition-opacity duration-500 pointer-events-none ${effectiveExpanded ? 'opacity-100' : ''}`} />
        </div>
      </nav>
        ...
        <div className="fixed inset-0 z-[60] bg-[#1a232d] mob-bg-in flex flex-col overflow-hidden overscroll-none h-[100dvh]">
            ...
            {navLinks.map((link, i) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-xl font-black text-slate-100 group-hover:text-white transition-colors tracking-tighter">
                    {link.name}
                  </span>
                </div>
          ...
          <div className="relative z-10 px-6 pb-10 mob-cta">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-[#C45919] hover:bg-[#A34915] text-white px-8 py-4 rounded-2xl text-base font-black shadow-lg shadow-[#C45919]/30 transition-all active:scale-95"
            >
