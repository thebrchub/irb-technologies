  ...
  return (
    <section className="bg-[#FDFBF7] py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] 2xl:max-w-[1600px] mx-auto px-6 lg:px-16 relative z-10">
        ...
        <ScrollReveal>
          {/* 🔥 FIXED: Reduced py-10 to py-8 on mobile to trim the top/bottom edges */}
          <div className="relative bg-slate-900 rounded-[2rem] lg:rounded-[3rem] px-6 py-8 md:px-12 md:py-12 lg:px-16 lg:py-14 2xl:px-20 2xl:py-16 overflow-hidden shadow-2xl shadow-slate-900/20 border border-slate-800">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
              ...
              {/* 🔥 MOBILE FIX: Parent is items-center to center the Pill and Heading */}
              <div className="flex flex-col items-center lg:items-start w-full max-w-2xl 2xl:max-w-4xl">
                ...
                {/* 🔥 Heading is centered on mobile, left on desktop */}
                ...
                {/* 🔥 Description explicitly locked to left-align on mobile and desktop */}
                <p className="text-left text-base md:text-lg 2xl:text-xl text-slate-300 leading-relaxed font-light max-w-xl w-full">
              ...
              {/* 🔥 DESKTOP FIX: Added lg:translate-y-3 to nudge the button down into perfect visual center! */}
              <div className="flex flex-col items-center lg:items-end shrink-0 w-full lg:w-auto mt-2 lg:mt-0 lg:translate-y-3">
                
                {/* Button stays full width on mobile, auto on desktop */}
                <button 
                  onClick={onOpenModal}
                ...
                {/* Status indicator aligns center on mobile, right on desktop */}
